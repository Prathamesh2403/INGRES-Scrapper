...
try:
    ...
    # --- MODIFIED SCRIPT TO PROCESS ONLY ONE YEAR ---
    target_year = "2012-2013"
    print(f"\n--- Processing a single year: {target_year} ---")
    
    # --- REVERTING TO JAVASCRIPT METHOD - The most reliable solution for this element ---
    ...
    time.sleep(1) # Add a brief pause to ensure the event is processed
    ...
    for state in state_names:
        try:
            ...
            # Instead of refreshing the whole page, we just try to recover and continue.
            try:
                # Attempt to close the dropdown to reset for the next state
