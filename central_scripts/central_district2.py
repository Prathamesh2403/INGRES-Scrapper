...
try:
    ...
    # --- NEW: A unique locator for the District's "Select All" button ---
    ...
    for state in state_names:
        ...
        for attempt in range(max_retries):
            try:
                ...
                # --- Using the new, unique locator for "Select All" ---
                print("    -> Waiting for 'Select All' to be clickable...")
                select_all_districts = wait.until(EC.element_to_be_clickable(district_select_all_locator))
