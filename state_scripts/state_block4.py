    ...
    for state in state_names:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "VALLEY" in top_view_options:
                    sub_division_label = "Valley"
                elif "TEHSIL" in top_view_options:
                    sub_division_label = "Tehsil"
                elif "TALUK" in top_view_options:
                    sub_division_label = "Taluk"
