#main working file 2
#Radio: State, selects all blocks for all districts of each state
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "ISLAND" in top_view_options:
                    ...
                    raise Exception("Could not find a valid Top view option (ISLAND, TALUK, BLOCK, MANDAL, or DISTRICT).")
                ...
                # --- 6. Select all Sub-divisions (Taluk/Mandal/Block) ---
